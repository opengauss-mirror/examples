...
def ensure_opengauss_database_exists():
    ...
    import urllib.parse
    encoded_password = urllib.parse.quote_plus(settings.pg_password)
    conn_string_postgres = f"postgresql://{settings.pg_user}:{encoded_password}@{settings.pg_host}:{settings.pg_port}/postgres"
    ...
    try:
        ...
        target_conn_string = f"postgresql://{settings.pg_user}:{encoded_password}@{settings.pg_host}:{settings.pg_port}/{settings.pg_db}"
