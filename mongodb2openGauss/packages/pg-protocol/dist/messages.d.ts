...
export declare class AuthenticationSHA256Password implements BackendMessage {
    readonly length: number;
    readonly random64code: String;
    readonly token: String;
    readonly server_iteration: Number;
    readonly isSM3: Boolean;
    readonly name: MessageName;
    constructor(length: number, random64code: String, token: String, server_iteration: Number, isSM3: Boolean);
}
export declare class AuthenticationMD5SHA256Password implements BackendMessage {
    readonly length: number;
    readonly random64code: String;
    readonly salt: Buffer;
    readonly name: MessageName;
    constructor(length: number, random64code: String, salt: Buffer);
}
