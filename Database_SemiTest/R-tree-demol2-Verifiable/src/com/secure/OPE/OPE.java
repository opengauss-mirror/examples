...
//		for (int i = 0; i <= 999999999; i=i+10) {
//
//			BigInteger p = new BigInteger("" + i);
//
//			BigInteger e = o.encrypt(p);
//			BigInteger d = o2.encrypt(p);
//
//			if (d.compareTo(e) != 0)
...
//		}
		BigInteger encrypt = o.encrypt(new BigInteger("9999999"));
		System.out.println("加密9999999:"+encrypt);
		System.out.println("解密:"+o.decrypt(encrypt));
	}
}
